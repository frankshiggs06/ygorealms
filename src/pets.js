...
export const PETS_DATA = [
  ...
  { id: "pet16", name: "Capibara Freestyler", type: "capibara", hp: 150, atk: 1.1, def: 1.1, specialty: "Mate", svg: `<svg viewBox="0 0 100 100" class="pet-svg">
    <!-- Body -->
